...
class Monuseg_image_dataset(Dataset):
    def __init__(self, data_path):
        image_files = glob.glob(os.path.join(data_path, '*.tif'))
        self.images = map(Image.open, image_files)
        ...
        mean_std_file = '/home/arnav/Disk/HistologyNet/TransNuSS/data/monuseg_tiles_512x512/monuseg_tiles_mean_std.txt'
    ...
    def __getitem__(self, index):
        ...
        image_scaled, left, top, right, bottom = self.get_scaled_image(image, scale)
